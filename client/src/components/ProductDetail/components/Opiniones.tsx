    ...
    <section className="banner-opiniones">
      <h1 className="h1">Lo que opinan nuestros alumnos</h1>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={h1} alt='Morech Inostroza'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={m1} alt='Inesinha Castedo Velasco'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={m2} alt='Valentina Ignacia Araya Parraguez'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={h2} alt='Miguel Carrera'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={h3} alt='Fernando Fernández'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={m3} alt='Veronica Villarroel Carreño'/>
                </section>
            </div>
            <div className="text">
                <div>
        ...
        <SwiperSlide>
            <div className='card'>
                <section className='slide-1'>
                    <img className='me' src={m4} alt='Alexa Soares'/>
                </section>
            </div>
            <div className="text">
                <div>
