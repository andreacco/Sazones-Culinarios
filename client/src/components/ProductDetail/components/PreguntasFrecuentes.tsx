    ...
    <div className='div-PreguntasFrecuentes'>
      ...
      <div className='div-divs-preguntas'>
        <div className="div-izq">
          <div className={open.p1 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p1")}>
          ...
          <div className={open.p2 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p2")}>
            <div className="div-pregunta">
          ...
          <div className={open.p3 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p3")}>
            <div className="div-pregunta">
        ...
        <div className="div-der">
          <div className={open.p4 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p4")}>
            <div className="div-pregunta">
          ...
          <div className={open.p5 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p5")}>
            <div className="div-pregunta">
          ...
          <div className={open.p6 === true ? "div-cada-pregunta open" : "div-cada-pregunta"} onClick={() => handleOpen("p6")}>
            <div className="div-pregunta">
