import { GET_ALL_PRODUCTS, SUBSCRIBE_USER, GET_ALL_CATEGORIES, SET_TITLE, RESET_SUB, RESET, GET_BEST_SELLERS, GET_BANNER_PRODUCTS, GET_SEARCH_PRODUCTS } from '../actions/index'
