...
const index_11 = __importDefault(require("./Products/GetProductById/index"));
const index_12 = __importDefault(require("./Products/PutProducts/index"));
...
router.use('/', index_11.default);
router.use('/', index_12.default);
